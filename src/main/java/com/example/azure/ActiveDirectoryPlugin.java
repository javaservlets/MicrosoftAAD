 ...
 * @since AM 5.5.0
 */
public class ActiveDirectoryPlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(ActiveDirectoryPlugin.currentVersion,
				Collections.singletonList(ActiveDirectory.class));
	}
	...
	public String getPluginVersion() {
		return ActiveDirectoryPlugin.currentVersion;
	}
}
